...
def test_send_text(instance):
    ...
    if shared:
        session.SendCard(shaed.get('wxid'), shared.get('wxNickName'))
...
if __name__ == '__main__':
    ...
    test_send_text(wx)
    # # wx.SendAtText('44043383416@chatroom','wxid_wt8bvv5gcerl22',"1")
    # wx.SendText('47743077202@chatroom','test')
